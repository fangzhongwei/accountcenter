...
public class DepositRequestResponse extends AccountBaseResponse
{
    ...
    public DepositRequestResponse(String code, String paymentVoucherNo, int tradeStatus, String extUrl, String ext1, String ext2, String ext3, String ext4, String ext5)
    {
        super(code);
    ...
    clone()
    {
        return (DepositRequestResponse)super.clone();
    }

    public static final long serialVersionUID = 1562609185338401735L;
}
