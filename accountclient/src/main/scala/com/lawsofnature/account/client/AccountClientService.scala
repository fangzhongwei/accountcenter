...
class AccountClientServiceImpl @Inject()(@Named("account.ice.client.init.config") iceInitConfig: String,
                                   ...
                                   icePrxFactory: IcePrxFactory) extends AccountClientService {
  ...
  override def queryDepositOrder(traceId: String, paymentVoucherNo: String): DepositResponse = accountEndpoint.queryDepositOrder(traceId, paymentVoucherNo)
